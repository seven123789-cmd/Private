const APP = (() => {
  ...
  const sidebarIconSrc = (name) => {
    return `assets/img/imperial/sidebar/menu-${name}.webp`;
  };
    ...
    sb.innerHTML = `
      <div class="imperial-brand-card">
        <span class="icon-frame icon-frame-brand" aria-hidden="true">
          <img src="assets/img/imperial/icons/brand-emblem.webp" alt="" loading="eager">
        </span>
      ...
      <div class="imperial-user-card">
        <div class="imperial-user-avatar">
          <img src="assets/img/imperial/sidebar/admin-emblem.webp" alt="管理者" loading="eager">
        </div>
        <div>
